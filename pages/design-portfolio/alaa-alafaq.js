        ...
        <div className="w-6xl mx-auto max-container-width">
          ...
          <div className="single-portfolio-wrapper flex mt-5 gap-6 mb-30">
            <div className="single-portfolio-left">
              <Image src="/alaa.png" width={500} height={500} />
            </div>
            ...
            <div className="single-portfolio-right">
              ...
              <div className="portfolio-single-description-wrapper flex align-center gap-3 border-[#30283b] border-2 rounded-lg py-2 px-3 mb-4">
                ...
                <p className="poppins-font text-[18px]">
                  ...
                  <span className="font-bold">
                    Custom Logo Design, Letterhead and Envelope
                  </span>
                </p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 p-5 rounded-xl text-sm font-light text-white/90 shadow-sm space-y-3">
                ...
                <p className="poppins-font text-[16px]">
                  Alaa Alafaq, a Saudi-based business, reached out to us for a
                  professional brand identity that reflects credibility and
                  corporate elegance. We designed a custom bilingual logo, along
                  with a matching letterhead and envelope to ensure cohesive
                  branding across all formal communication.
                </p>
                <p className="poppins-font text-[16px]">
                  The result is a clean, sophisticated identity that balances
                  Arabic and English elements while maintaining clarity,
                  authority, and a polished visual presence.
                </p>
              </div>
            </div>
          </div>
