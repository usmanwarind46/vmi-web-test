            ...
            <div className="single-portfolio-right">
              ...
              <div className="bg-white/5 border border-white/10 p-5 rounded-xl text-sm font-light text-white/90 shadow-sm space-y-3">
                ...
                <p className="poppins-font text-[16px]">
                  Loco’s Customs, a Manchester based car wrapping and window
                  tinting expert, approached us to build a complete digital
                  presence that reflects their bold, high performance service
                  offering. We handled both the design and development of a
                  custom website that not only showcases their work but also
                  drives inbound leads and appointments.
                </p>
                <p className="poppins-font text-[16px]">
                  The design phase focused on a sleek, automotive inspired
                  aesthetic with impactful visuals, sharp layouts, and strong
                  CTAs. We crafted each page in Figma with attention to flow,
                  user engagement, and SEO friendly structure. The development
                  followed on WordPress, ensuring fast loading, mobile
                  responsiveness, and easy content updates.
                </p>
                <p className="poppins-font text-[16px]">
                  The end result is a high converting website that’s fast,
                  modern, and perfectly aligned with Loco’s brand identity and
                  business goals.
                </p>
              </div>
            </div>
